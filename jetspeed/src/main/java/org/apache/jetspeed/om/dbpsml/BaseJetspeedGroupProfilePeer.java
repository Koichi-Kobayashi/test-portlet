    ...
    extends BasePeer
{
        ...
        throws TorqueException
    {
        try
        {
            ...
            BaseJetspeedGroupProfilePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        ...
        for (int i = 0; i < records.size(); i++)
        {
            Record row = (Record) records.get(i);
              results.add(BaseJetspeedGroupProfilePeer.row2Object(row, 1,
                BaseJetspeedGroupProfilePeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List doSelect(JetspeedGroupProfile obj) throws TorqueException
    {
